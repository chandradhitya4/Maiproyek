			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						<h1>Daftar</h1>
						<h4>Bergabung dengan ribuan mahasiswa lainya</h4>
						<form class="row login_form" action="<?php echo site_url('Login/add')?>" method="post" id="contactForm" novalidate="novalidate">
							...
							<div class="col-md-12 form-group">
                                ...
                                <a href="<?php echo base_url('Login/index');?>">Sudah punya akun ? <strong class="logina">Login</strong></a>
							</div>
						</form>
					</div>
				</div>
