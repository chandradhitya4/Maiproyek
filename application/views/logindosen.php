...
<section style="padding :50px 0">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="login_box_img" style="margin-right : 20px; padding : 50px 0">
                    <h3 style="color : #03A678"> Masuk dan menemukan mahasiswa mahasiswa terbaik untuk proyek anda </h3>
                ...
                <div class="login_form_inner">
                    ...
                    <form class="row login_form" action="<?php echo site_url('Login/ceklogin')?>" method="post" id="contactForm" novalidate="novalidate">
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <a href="<?php echo base_url('Login/registerd');?>">Belum punya akun ? <strong class="logina">Daftar disni</strong></a>
                        </div>
                    </form>
                </div>
            </div>
