					...
					<div class="row fullscreen align-items-center">
							<div class="row">
								<div style="margin-top :150px;">
									<h3 class="text-uppercase" style="font-weight : 700; color :#03a678">Proyek Anda</h3> <br/>
								</div>
							</div>
					</div>
					<div class="row">
							...
							<div class="container">
								<div class="card">
									...
									<div class="card-body"> <!-- Item 1 -->
										<div class="col"> 
											<div class="container">
												<h5 class="card-title" style="display:inline-block">Pembuatan Aplikasi Absensi</h5> 
												<a href="<?php echo site_url('Dosen/Home_dosen/detailProyekDosen')?>" class="btn btn-danger float-right">Lihat</a>
											</div>	
													<div class="container">
														<h6 class="card-subtitle">Telkom University</h6>
													</div>
											</div>
										</div>
