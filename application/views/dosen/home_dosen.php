...
<!--                            --><?php //foreach($profile as $b =>  $row){?>
                            <li><a href="<?php echo base_url() ?>Dosen/Home_dosen/detProfile/">Profil</a></li>
<!--                            --><?php //}?>
                            <?php $this->session->userdata('email') ?>
                            ...
                            <div class="card-body"> <!-- Item 1 -->
                                <div class="col">
                                    <div class="container">
                                        ...
                                        <a href="<?php echo base_url() ?>Dosen/Buat_proyek/detProduct/<?=$row->proyek_id;?>" class="btn btn-danger float-right">Lihat</a>
                                        <a href="<?php echo base_url() ?>Dosen/Buat_proyek/updatepro/<?=$row->proyek_id;?>" class="btn btn-danger float-md-right">Update</a>
                                        <a href="<?php echo base_url() ?>Dosen/Buat_proyek/del/<?=$row->proyek_id;?>" onclick="return confirm('Anda yakin akan menghapus data?')" class="btn btn-danger float-md-right">Delete</a>
                                    </div>
                                    <div class="container">
