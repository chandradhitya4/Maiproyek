									...
									<div class="card-body"> <!-- Item 1 -->
										<div class="col"> 
											<div class="container">
												...
												<a href="<?php echo site_url('Dosen/Home_dosen/detailProyekDosen/'."<?=$row->nama_proyek;?>")?>" class="btn btn-danger float-right">Lihat</a>
											</div>	
													<div class="container">
...
<body>
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item active"><a class="nav-link" href="<?php echo site_url('Dosen/Home_dosen/buatProyek')?>">Buat Proyek</a></li> <!--tombol buat proyek -->
    ...
    <section class="ftco-section bg-light">
          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
            <h2 class="mb-4"><span>Proyek</span> Anda</h2>
          </div>
        </div>
				<div class="row">
