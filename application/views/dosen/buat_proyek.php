                        ...
                        <div class="card">
                            ...
                            <form style="text-align:left">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="inputNamaProyek" name="inputNamaProyek" placeholder="Beri Nama Proyek Anda">
                                </div>
                                <div class="form-group">
                                    <label for="inputNamaUniv">Universitas</label>
                                    <input type="text" class="form-control" id="inputNamaUniv" name="inputNamaUniv" placeholder="Masukkan Nama Universitas Anda">
                                </div>
                                <div class="form-group">
                                    <label for="inputNamaFakultas">Fakultas</label>
                                    <select id="inputNamaFakultas" class="form-control">
                                        <option>-</option>
                                        <option>FTE</option>
                                        <option>FRI</option>
                                        <option>FIF</option>
                                ...
                                <div class="form-group">
                                    <label for="inputNamaJurusan">Jurusan</label>
                                    <select id="inputNamaJurusan" class="form-control">
                                        <option>-</option>
                                ...
                                <div class="form-group">
                                    <label for="inputDeskripsi">Deskripsi Proyek</label>
                                    <textarea cols="39" rows="7" name="textDeskripsi" id="Deskripsi" class="form-control"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="inputBidang">Bidang</label>
                                    <input type="text" class="form-control" id="inputBidang" name="inputBidang" placeholder="Masukkan Bidang Proyek Anda">
                                </div>
                                <div class="form-group">
                                    <label for="inputKeahlian">Keahlian</label>
                                    <input type="text" class="form-control" id="inputKeahlian" name="inputKeahlian" placeholder="Masukkan Keahlian yang dibutuhkan untuk proyek anda">
                                </div>
                                <div class="form-group">
                                    <label for="inputJumlah">Jumlah Mahasiswa yang dibutuhkan</label>
                                    <select class="form-control" id="inputJumlah">
                                        <option>1</option>
                                        <option >2</option>
                                        <option >3</option>
                                        <option>4</option>
                                ...
                                <div class="form-group">
                                    <label for="inputPenawaran">Tawaran Minimum</label>
                                    <input type="text" class="form-control" id="inputPenawaran" name="inputKPenawaran" placeholder="Masukkan Jumlah Tawaran Minimum">
                                </div>
                                <div class="form-group">
                                    <label for="inputPenawaran">Tawaran Minimum</label>
                                    <input type="text" class="form-control" id="inputPenawaran" name="inputKPenawaran" placeholder="Masukkan Jumlah Tawaran Minimum">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="RadioTawar" id="RadioTawarYa" value="Yes" checked>
                                    <label class="form-check-label" for="RadioTawar">Ya</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="RadioTawar" id="RadioTawarTidak" value="No">
                                ...
                                <div class="form-check">
                                    ...
                                    <button type="submit" onclick="window.print()" class="btn btn-danger btn-md">Pasang Iklan</button>
                            </form>
